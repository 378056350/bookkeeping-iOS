...
#define PLUS_TAG 13         // 加
#define LESS_TAG 17         // 减
...
#pragma mark - 声明
@interface StartKeyboard()<UITextFieldDelegate>
...
- (void)initUI {
    ...
    [self.moneyConstraintH setConstant:countcoordinatesX(45)];
    ...
    [self setBackgroundColor:[kColor_Line_Color colorWithAlphaComponent:1]];
    [self.moneyLab setFont:[UIFont systemFontOfSize:AdjustFont(14)]];
    [self.moneyLab setTextColor:kColor_Text_Black];
}
- (void)createBtn {
...
////        NSDate *min = [NSDate dateWithYMD:@"2000-01-01"];
////        NSDate *max = [NSDate dateWithYMD:[NSString stringWithFormat:@"%ld-12-31", date.year + 3]];
